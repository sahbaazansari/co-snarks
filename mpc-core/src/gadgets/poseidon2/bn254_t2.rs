use crate::gadgets::poseidon2::Poseidon2T2D5Params;
...
pub static POSEIDON2_BN254_T2_PARAMS: LazyLock<Poseidon2T2D5Params<Scalar>> =
    LazyLock::new(|| Poseidon2T2D5Params::new(ROUNDS_F, ROUNDS_P, &EXTERNAL_RC, &INTERNAL_RC));
